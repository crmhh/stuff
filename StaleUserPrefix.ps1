...
Modified by Chris Brumm to filter on Prefix
#>
...
$Export | Where-Object {$_.userPrincipalName.Startswith("$($Prefix)","CurrentCultureIgnoreCase")} | sort -Property { $_.LastLoginDate -as [datetime] } -Descending | Out-GridView